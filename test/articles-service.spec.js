...
describe('Articles service object', function() {
    ...
    let testArticles = [
        ...
        },
        {
            ...
            content: 'More lorem ipsum text'
        },
        {
            id: 3,
            date_published: new Date('2029-01-22T16:28:32.615Z'),
            title: 'Third test post!',
            content: 'Even more lorem ipsum text'
        },
    ]
  ...
  context(`Given 'blogful_articles' has data`, () => {
    beforeEach(() => {
       ...
       it(`getAllArticles() resolves all articles from 'blogful_articles' table`, () => {
           //test that ArtclesService.getAllArticles gets data from table
       ...
       it(`getById() resolves and artice by id from 'blogful_articles' table`, () => {
           const thirdId= 3
